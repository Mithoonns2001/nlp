...
# Your dataset
with open('C:/Users/NAGARAJAN K/Desktop/initial/train_data.txt', 'r', encoding='utf-8') as f:
    data = f.read()

input_texts, target_texts = data
...
print(context, max_new_tokens=2000)[0].tolist()
# Save the model
